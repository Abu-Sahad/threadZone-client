...
const SellerNotification = () => {
  ...
  useEffect(() => {
    axios.post('https://thread-zone-server-abu-sahad.vercel.app/getNotification', { role: 'seller', shopId: userInfo.shopId })
      .then(res => {
  ...
  const handleRead = (id) => {
    ...
    //if(!singleNot.isRead){
    axios.post('https://thread-zone-server-abu-sahad.vercel.app/updateNotification', { id: id })
      .then(res => {
        if (res.data.status) {
          Swal.fire({
            icon: 'success',
  ...
  const deleteNotification = (id) => {
    axios.post('https://thread-zone-server-abu-sahad.vercel.app/deleteNotification', { id: id })
      .then(res => {
        if (res.data.status) {
          Swal.fire({
            icon: 'warning',

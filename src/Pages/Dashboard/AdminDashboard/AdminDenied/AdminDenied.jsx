...
const AdminDenied = () => {
    ...
    const fetchProductsData = async () => {
        try {
            const response = await axios.get('https://thread-zone-server-abu-sahad.vercel.app/products');
    ...
    const handleAdminDenied = async (id) => {
        try {
            const response = await axios.put(`https://thread-zone-server-abu-sahad.vercel.app/products/${id}`, { isBlock: true });

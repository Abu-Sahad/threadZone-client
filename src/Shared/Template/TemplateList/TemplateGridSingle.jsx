         ...
         <Link  to={`../product/productDetails/${params.item._id}`}>  
              {/* <h4 className="uppercase font-medium text-xl mb-2 h-18 text-gray-800 hover:text-primary transition ">{productName} </h4>  */}
               ...
               <div className="pt-4 pb-3 px-4 ">
                    ...
                    <div className="flex items-center h-4 -me-3 ">
                    ...
                    <div className="flex items-baseline mb-1 space-x-2 " >
                         ...
                         <p className="text-sm text-gray-400 font-roboto  line-through "> {parseInt( price)+parseInt(discount)}</p>
                    </div>
                    
               </div>
               <button onClick={handleAddProduct} className="block w-full py-1 text-center text-cDarkBlue bg-transparent border border-cLightBlue rounded-b font-medium hover:bg-cDarkBlue  hover:text-white transition " >
                    Add To Cart
               </button>
          </div>
       </div>
